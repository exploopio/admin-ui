                ...
                {newApiKey ? (
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-start gap-2 p-3 bg-yellow-50 dark:bg-yellow-900/20 rounded-md text-sm">
                        ...
                        <p className="text-yellow-800 dark:text-yellow-200">
                          This API key will only be shown once. Share it securely with the new
                          administrator.
                        </p>
                      </div>
                    </div>
                  ...
                  <>
                    <DialogHeader>
                      ...
                      <DialogDescription>Create a new platform administrator</DialogDescription>
                    </DialogHeader>
                    <div className="space-y-4">
                        ...
                        >
                          ...
                          <SelectContent>
                            ...
                            <SelectItem value="ops_admin">
                              Ops Admin (manage agents/tokens)
                            </SelectItem>
                    ...
                    <TableCell>
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                          <DropdownMenuItem
                            onClick={() => setRotateDialog({ open: true, admin, newKey: null })}
                          >
        ...
        <DialogContent>
          {rotateDialog.newKey ? (
            <>
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-2 p-3 bg-muted rounded-md">
                  <code className="flex-1 text-sm font-mono break-all">{rotateDialog.newKey}</code>
                  <CopyButton text={rotateDialog.newKey} />
                </div>
              </div>
              <DialogFooter>
                <Button onClick={() => setRotateDialog({ open: false, admin: null, newKey: null })}>
                  Done
                </Button>
              </DialogFooter>
            </>
            ...
            <>
              <DialogHeader>
                ...
                <DialogDescription>
                  ...
                  <span className="font-medium">{rotateDialog.admin?.name}</span>. The current key
              ...
              <DialogFooter>
                <Button
                  variant="outline"
                  onClick={() => setRotateDialog({ open: false, admin: null, newKey: null })}
                >
                  Cancel
                </Button>
        ...
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              <span className="font-medium">{deleteDialog.admin?.name}</span>? This action cannot be
              undone.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
